      ...
      <div class="container">
        <div class="row">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8">
                          <div class="inner-content clearfix">
                              ...
                              <p class="description">
                                <!-- substr() :- function use to jyada word ko kam letter m likhne k lye krte h-->
          ...
          $sql1 = "SELECT * FROM post
                   WHERE post.title LIKE '%{$search_term}'"; // like % this funtion use to take the data from the database which we can search in the search bar(we cam fetch data easily from the search)
